...
| env | object | `{}` | map of plain environment variables to inject into the reporter container. If you are on a single-tenant Kosli instance, set KOSLI_HOST:   env:     KOSLI_HOST: https://<instance_name>.kosli.com |
