...
#curl -o merkely_$KOSLI_CLI_VERSION.tar.gz -L https://github.com/kosli-dev/cli/releases/download/v$KOSLI_CLI_VERSION/kosli_${KOSLI_CLI_VERSION}_linux_amd64.tar.gz
