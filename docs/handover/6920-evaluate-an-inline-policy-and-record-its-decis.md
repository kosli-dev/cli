...
**Visibility.** The command is hidden while it is proved out, so it appears in no help listing and generates no docs page. The ticket asks for a published command; that is the last slice's decision, not a change of intent.
