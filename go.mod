...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.32.6
...
replace k8s.io/cri-api => k8s.io/cri-api v0.32.6
...
replace k8s.io/mount-utils => k8s.io/mount-utils v0.32.6
...
replace k8s.io/externaljwt => k8s.io/externaljwt v0.32.6
