...
# description: |
#   Every commit trail must have independent review. Service-account commits
#   (CI bots, GitHub Actions, dependabot, etc.) are exempt. Human-authored
#   commits require an associated PR with at least one approver who did not
#   author any of the commits and approved after the latest code commit.
#   Uses a fail-closed model: any trail that cannot be evaluated is treated
#   as non-compliant.
package policy
...
# METADATA
# title: Trail satisfies four-eyes
# scope: document

# METADATA
# title: service-account commit — exempt from PR review
# scope: rule
