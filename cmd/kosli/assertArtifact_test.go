	...
	tests := []cmdTestCase{
		{
			...
			golden:    "Error: Artifact with fingerprint '8e568bd886069f1290def0caabc1e97ce0e7b80c105e611258b57d76fcef234c' does not exist in pipeline 'some-flow' belonging to 'docs-cmd-test-user'. \n",
		},
		{
