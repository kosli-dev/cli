...
The ^.kosli_ignore^ will be treated as part of the artifact like any other file, unless it is explicitly ignored itself.`
	...
	getAttestationFingerprintFlag        = "[optional] The fingerprint of the artifact for the attestation. Cannot be used together with --trail."
	getAttestationTrailFlag              = "[optional] The Kosli trail name for the attestation. Cannot be used together with --fingerprint."
)
