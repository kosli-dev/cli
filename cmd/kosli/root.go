...
The ^.kosli_ignore^ will be treated as part of the artifact like any other file, unless it is explicitly ignored itself.`
	...
	sonarWaitFlag                        = "[optional] Allow the command to check and wait for the SonarQube scan to complete, if necessary. Useful for scans that take a long time to complete. Defaults to false."
