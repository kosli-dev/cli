...
More details can be found here: https://aws.github.io/aws-sdk-go-v2/docs/configuring-sdk/#specifying-credentials
	...
	evidenceFileFlag        = "[optional] The file that contains supporting proof for the reported evidence. Cannot be used together with --evidence-fingerprint or --evidence-url."
