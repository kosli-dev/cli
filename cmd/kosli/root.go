...
The ^.kosli_ignore^ will be treated as part of the artifact like any other file, unless it is explicitly ignored itself.`
	...
	repoProviderFlag                = "[optional] The source code hosting provider. One of: github, gitlab, bitbucket, bitbucket_cloud, bitbucket_dc, azure-devops, azure_devops_services, azure_devops_server, generic_git, subversion (defaulted in some CIs: https://docs.kosli.com/integrations/ci_cd )."
