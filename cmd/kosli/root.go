...
The service principal needs to have the following permissions:  
  ...
  2) Microsoft.ContainerRegistry/registries/pull/read  
	...
	bucketPathsFlag             = "[optional] The comma separated list of file and/or directory paths in the S3 bucket to include when fingerprinting."
	excludeBucketPathsFlag      = "[optional] The comma separated list of file and/or directory paths in the S3 bucket to exclude when fingerprinting."
