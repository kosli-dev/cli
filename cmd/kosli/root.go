...
The ^.kosli_ignore^ will be treated as part of the artifact like any other file, unless it is explicitly ignored itself.`
	...
	attestationTypeSummaryJsonFlag  = "[optional] The attestation type summary, given as a JSON array of {name, expression} entries, e.g. '[{\"name\":\"Critical\",\"expression\":\".critical_count\"}]'."
