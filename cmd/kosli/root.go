...
More details can be found here: https://aws.github.io/aws-sdk-go-v2/docs/configuring-sdk/#specifying-credentials
	...
	resultsDirFlag          = "[defaulted] The path to a directory with JUnit test results. For paid plans, the directory will be uploaded to Kosli's evidence vault."
	snykJsonResultsFileFlag = "The path to Snyk scan results JSON file from 'snyk test' and 'snyk container test'. For paid plans, the Snyk results will be uploaded to Kosli's evidence vault."
