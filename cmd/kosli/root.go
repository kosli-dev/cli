...
The ^.kosli_ignore^ will be treated as part of the artifact like any other file, unless it is explicitly ignored itself.`
	...
	apiKeyGracePeriodHoursFlag      = "[defaulted] How many hours the old API key remains valid after rotation, to allow time to update dependent systems."
	revokeApiKeyYesFlag             = "[optional] Skip the confirmation prompt and revoke the API key without asking. (alias: --yes)"
