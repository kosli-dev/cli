...
The ^.kosli_ignore^ will be treated as part of the artifact like any other file, unless it is explicitly ignored itself.`
	...
	eventsStartTSFlag                = "[optional] The start of the events range as a Unix timestamp (integer or float)."
	eventsEndTSFlag                  = "[optional] The end of the events range as a Unix timestamp (integer or float)."
