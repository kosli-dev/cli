...
More details can be found here: https://aws.github.io/aws-sdk-go-v2/docs/configuring-sdk/#specifying-credentials
	...
	evidenceFingerprintFlag = "[optional] The SHA256 fingerprint of the evidence file or dir. Cannot be used together with --evidence-flag."
	evidenceURLFlag         = "[optional] The external URL where the evidence file or dir is stored. Cannot be used together with --evidence-flag."
	evidencePathsFlag       = "[optional] The comma-separated list of paths containing supporting proof for the reported evidence. Cannot be used together with --evidence-fingerprint or --evidence-url."
