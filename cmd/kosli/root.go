...
The ^.kosli_ignore^ will be treated as part of the artifact like any other file, unless it is explicitly ignored itself.`
	...
	jiraTrailerFlag                 = "[optional] The git trailer key to use as the sole source of Jira issue references (e.g. '--jira-trailer Jira' extracts the value of 'Jira: <issue-key>' lines from the final paragraph of the commit message). When set, the commit message body and branch name are not scanned. Mutually exclusive with --jira-secondary-source."
