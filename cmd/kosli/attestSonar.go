...
If there are delays in the scan processing (either because the scanned project is very large, or because SonarQube is experiencing delays), you can use the --allow-wait flag to
wait for the scan to be processed before trying to attest the results.
