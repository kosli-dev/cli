...
func newArtifactCmd(out io.Writer) *cobra.Command {
	...
	cmd.Flags().StringVarP(&o.inputSha256, "sha256", "s", "", "The SHA256 fingerprint for the artifact to be approved. Only required if you don't specify --artifact-type.")
	...
	cmd.Flags().BoolVarP(&o.payload.IsCompliant, "compliant", "C", true, "[optional] Whether the artifact is compliant or not. Use '-C=false' to mark as non-compliant.")
