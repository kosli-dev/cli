...
<a href="https://app.kosli.com/api/v2/livedocs/cyber-dojo/cli?command=kosli+get+flow+dashboard-ci+--output=json">kosli get flow dashboard-ci --output=json</a></pre>{{< / raw-html >}}
